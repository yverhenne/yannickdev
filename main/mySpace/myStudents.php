...
if (api_get_configuration_value('improve_tracking_in_mystudent_php')) {
    ...
    $donutContent .= '</div>';
    $donutContent .= '</div>';
    $donutPanel = Display::panel($donutContent.$timePanel, get_lang('AverageProgressInSessions'));
    ...
    $sessionBarsPanel = Display::panel($sessionBars, get_lang('ProgressionInSessions'));
