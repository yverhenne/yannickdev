...
$editIcon = Display::return_icon('edit.png', get_lang('EditFields', 'user_profile'));
...
echo '<thead><tr><th width="30"></th><th>'.get_lang('Name').'</th><th>'.get_lang('Type').'</th><th>'.get_lang('Category').'</th><th>'.get_lang('ShowTracking').'</th><th>'.get_lang('Actions').'</th></tr></thead><tbody>';
...
$tracking = $form->createElement('checkbox', 'include_tracking', '', get_lang('ShowTracking', 'user_profile'));
